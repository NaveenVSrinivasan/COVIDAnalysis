...
# visualize_embeddings(text_to_embeddings,reduce_fn="TSNE",write_to_file=True,file_name='embeddings_reduced_data_tf_idf') #visualize embeddings and write the reduced data to tsv file for visualizer
